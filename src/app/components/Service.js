    ...
    <section className="py-16">
      <div className="max-w-7xl mx-auto text-center px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <div className="bg-white  bg-opacity-10 p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:scale-105">
            <div className="mb-6 text-blue-500">
              <svg className="w-20 h-20 mx-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M3 5h18M3 12h18M3 19h18" />
              </svg>
            </div>
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Website Development</h3>
          ...
          <div className="bg-white bg-opacity-10 p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:scale-105">
            ...
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Mobile Application</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white bg-opacity-10 p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:scale-105">
            ...
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Networking</h3>
            <p className="text-gray-600">
